...
@section('title', 'Manajemen Data Role')
...
@section('content-header')
    <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
        <h3 class="content-header-title mb-0 d-inline-block">Manajemen Data Role User</h3>
        <div class="row breadcrumbs-top d-inline-block">
            <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="/home">Home</a>
                    </li>
                    <li class="breadcrumb-item active">Role User
                    </li>
                </ol>
            </div>
        </div>
                        ...
                        <tbody>
                            ...
                            @foreach($roles as $item)
                                <tr>
                                    ...
                                    <td class="text-capitalize">{{ $item->user_id }}</td>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header bg-info white">
                <h4 class="modal-title white">Tambah Role User</h4>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control select2" name="user_id" style="width: 100% !important;" required>
                            ...
                            @foreach($users as $item)
                                <option value="{{ $item->id }}">{{ $item->phone_number }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="form-group">
                        <label for="">Nama Role</label>
                        <input type="text" name="role_name" placeholder="Masukkan nama role" class="form-control" required>
                    </div>
...
<div class="modal fade" id="editModal">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header bg-info white">
                <h4 class="modal-title white">Ubah data role</h4>
                <button type="button" class="close text-white" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span>
                </button>
            </div>
            <form action="" id="editForm" method="post">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="">Nama Role</label>
                        <input type="text" name="role_name" placeholder="Masukkan nama role" class="form-control" id='editUserId' required>
                    </div>
...
@section('script')
    <script>
        ...
        $(document).on("click", ".deleteButton", function()
        {
            ...
            $("#deleteForm").attr("action", "{{ route('roles.index') }}/" + id)
